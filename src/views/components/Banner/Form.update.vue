<template>
    <a-upload
      ...
      >
        <img v-if="form.imageUrl" :src="form.imageUrl" alt="avatar" width="100" height="80" />
        <div v-else>
    ...
    <script lang="ts" setup>
        ...
        const { update, form, fetchOne } = useMyBannerStore();
        ...
        onMounted(async () => {
            await fetchOne(Number(route.params.id));
        })
    </script>